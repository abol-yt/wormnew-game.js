...
async function loadServers() {
    ...
    try {
        const _0x292b49 = await fetchServersWithRetry('https://abol-yt.github.io/wormnew-game.js/api/server.php');
